    ...
    <div class="md:mt-0 md:col-span-2 mt-5">
      <form action="#" method="POST">
        <div class="sm:rounded-md shadow">
          ...
          <div class="sm:pb-6 flex px-4 pb-5 bg-white">
            ...
            <div class=" inline-flex w-3/12">
              <div class="relative w-full">
                ...
                <input id="from" type="text" name="from" class="sm:text-base focus:outline-none focus:border-blue-400 w-full py-2 pl-10 pr-4 text-sm placeholder-gray-500 border border-gray-400 rounded" placeholder="From" />
              </div>
            </div>
            ...
            <!-- <div class="grid grid-cols-12 gap-6">
              <div class="sm:col-span-6 lg:col-span-3 col-span-6">
                <div class="relative">
                  <div class="absolute top-0 left-0 inline-flex items-center justify-center w-10 h-full text-gray-400">
                    <svg class="w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              ...
              <div class="sm:col-span-6 lg:col-span-3 col-span-6">
                <div class="relative">
                  ...
                  <input id="to" type="text" name="to" class="sm:text-base focus:outline-none focus:border-blue-400 w-full py-2 pl-10 pr-4 text-sm placeholder-gray-500 border border-gray-400 rounded" placeholder="To" />
                </div>
              </div>
              ...
              <div class="sm:col-span-6 lg:col-span-2 col-span-6">
                <div class="relative">
                  ...
                  <input id="email" type="email" name="email" class="sm:text-base focus:outline-none focus:border-blue-400 w-full py-2 pl-10 pr-4 text-sm placeholder-gray-500 border border-gray-400 rounded" placeholder="Leaving" />
                </div>
              </div>
              ...
              <div class="sm:col-span-6 lg:col-span-2 col-span-6">
                <div class="relative">
                  ...
                  <input id="email" type="email" name="email" class="sm:text-base focus:outline-none focus:border-blue-400 w-full py-2 pl-10 pr-4 text-sm placeholder-gray-500 border border-gray-400 rounded" placeholder="Returning" />
                </div>
              </div>
          ...
          <!-- <div class="bg-gray-50 sm:px-6 px-4 py-3 text-center">
            <button type="submit" class="hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-blue-800 border border-transparent rounded-md shadow-sm">
              <svg class="w-6 h-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
              <span class="pl-1">Search</span>
      ...
      <div class="flex">
        ...
        <div class="w-6/12">
          ...
          <div class=" md:mb-4 relative flex flex-col w-full h-full px-4 pb-4 text-sm transition bg-gray-100 rounded cursor-pointer">
            ...
            <div class="py-0 bg-gray-100 border border-gray-200 rounded">
              <ul class="">
                <li>
                  <div class="hover:bg-white relative items-start px-4 py-3 overflow-hidden rounded">

                    <p class=" mb-2 text-sm font-semibold text-blue-500">Search</p>
                    <div class="flex justify-between">
                      <p class="mb-1 text-xs font-medium text-gray-500">Thu 12 March</p>
                    ...
                    <!-- next line -->
                    <div class="md:grid-cols-8 xl:grid-cols-9 hover:bg-gray-100 relative grid items-start p-8 px-2 py-1 mt-2 -mx-1 overflow-hidden border border-gray-100 rounded">
                      <p class="col-span-3 col-start-1 mb-0 text-xs font-medium text-gray-700">9:25 PM</p>
                      <p class="col-span-6 col-start-4 -ml-2 text-xs font-medium text-gray-500">Dallas <span>DFW</span></p>
                      <p class="col-span-3 col-start-1 mb-0 text-xs font-medium text-gray-700">8:25 AM</p>
                      <p class="col-span-6 col-start-4 -ml-2 text-xs font-medium text-gray-500">Kuala Lumpur <span>KUL</span></p>
                    </div>

                    <div class="h-1"></div>

                    <div class="md:grid-cols-8 xl:grid-cols-9 hover:bg-gray-100 relative grid items-start p-8 px-2 py-1 mt-2 -mx-1 overflow-hidden border border-gray-100 rounded">
                      <p class="col-span-3 col-start-1 mb-0 text-xs font-medium text-gray-700">11:45 AM</p>
                      <p class="col-span-6 col-start-4 -ml-2 text-xs font-medium text-gray-500">Kuala Lumpur <span>KUL</span></p>
                      <p class="col-span-3 col-start-1 mb-0 text-xs font-medium text-gray-700">1:25 AM</p>
                      <p class="col-span-6 col-start-4 -ml-2 text-xs font-medium text-gray-500">Dallas <span>DFW</span></p>
                    </div>
                ...
                <div id="comp_container">
                  <div class="p-6">
                    ...
                    <div class=" relative">
                      ...
                      <p class="mb-2 text-lg font-medium leading-5 text-gray-700">

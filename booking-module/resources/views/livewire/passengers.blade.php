<div>
    <div>
        ...
        <div class="relative flex flex-col w-full text-sm transition bg-white rounded shadow-md cursor-pointer">
    ...
    <div class="pt-0">
        <div class="flex justify-end">
            ...
            <button 
                wire:click="savePax" 
                class="hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 inline-flex items-center px-6 py-3 text-base font-medium text-white bg-indigo-600 border border-transparent rounded-md shadow-sm">
                Customize >
            </button>
        </div>
    </div>

<div class="flex h-screen overflow-hidden bg-gray-100">
  ...
  <div x-data="slideout()" x-cloak @open-menu.window="open = $event.detail.open" @keydown.window.tab="usedKeyboard = true" @keydown.escape="open = false" x-init="init()">
    <div x-show.transition.opacity.duration.500="open" @click="open = false" class="fixed inset-0 z-40 flex">
      <!--
      ...
      <div class="relative flex flex-col flex-1 w-full max-w-xs pt-5 pb-4 bg-indigo-700">
        ...
        <div class="absolute top-0 right-0 pt-2 -mr-12" :class="{'translate-x-full': !open}">
          <button @click="open = false" x-ref="closeButton" :class="{'focus:outline-none': !usedKeyboard}" class="focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white flex items-center justify-center w-10 h-10 ml-1 rounded-full">
  ...
  <div class="ml:flex ml:flex-shrink-0 hidden bg-indigo-700">

    <div x-show.transition.opacity.duration.500="open" @click="open = false" class="flex flex-col w-64">
      ...
      <div class="flex flex-col flex-1 h-0">
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
          ...
          <nav x-data class="flex-1 px-2 mt-5 space-y-1">
            <!-- Current: "bg-indigo-800 text-white", Default: "text-white hover:bg-indigo-600 hover:bg-opacity-75" -->

            <!-- <p>search: <span x-text="$wire.searchStep"></span></p>
            <p>passengers: <span x-text="$wire.passengerStep"></span></p> -->


            <div class=" hover:bg-indigo-600 flex flex-shrink-0 px-4 py-3 border-t border-indigo-800 rounded">
            ...
            <div x-bind:class="{'bg-indigo-800': $wire.searchStep}" class="flex flex-shrink-0 p-4 border-indigo-800 rounded">
              <a href="#" class="group flex-shrink-0 block">
            ...
            <div x-bind:class="{'bg-indigo-800': $wire.passengerStep}" class="hover:bg-indigo-600 hover:bg-opacity-75 flex flex-shrink-0 p-4 rounded">
              <a href="#" class="group flex-shrink-0 block">
                <div class="flex items-start">
                  <div>
            ...
            <div x-bind:class="{'bg-indigo-800': $wire.customizeStep}" class="hover:bg-indigo-600 hover:bg-opacity-75 flex flex-shrink-0 p-4 rounded">
              <a href="#" class="group flex-shrink-0 block">
                <div class="flex items-start">
                  <div>

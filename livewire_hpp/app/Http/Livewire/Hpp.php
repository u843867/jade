...
class Hpp extends Component
{
    ...
    public function render()
    {
        ...
        $this->order_json_symbol = $this->order_json['Symbol'];
        $this->order_json_amount = $this->order_json['Amount'];
        ...
        $this->emit('orderRendered', [$this->order_json_symbol, $this->order_json_amount]);
